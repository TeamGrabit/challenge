...
import { Main, colorTest, LogIn, MyPage, Register, Intro, ChallengeInfoFix, NowChallenge, ChallengeMake, RegisterInput } from "../pages";
	...
	return (
		<BrowserRouter>
			<Switch>
				...
				<Route exact path="/registerinput" component={RegisterInput} />
			</Switch>
		</BrowserRouter>
	);
}
